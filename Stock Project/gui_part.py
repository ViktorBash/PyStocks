...
This GUI gets info about stocks. It utilizes multiple scripts/files and the following Python modules:
PyQt5, Pandas, Numpy and yfinance. This script specifically is the GUI that handles the program display.
"""
import sys
...
# This class is responsible for the matplotlib that is shown when a stock is typed in
class Canvas(FigureCanvas):
    # Constructor that creates canvas instance
    ...
    @pyqtSlot()
    def plot(self):
        # Old chart that is just a fill in
        # x = np.array([50, 30, 40])
